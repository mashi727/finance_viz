...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.glw = GraphicsLayoutWidget(self.centralwidget)
        self.glw.setObjectName(u"glw")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.glw.sizePolicy().hasHeightForWidth())
        self.glw.setSizePolicy(sizePolicy)
        self.glw.setMinimumSize(QSize(1000, 0))

        self.horizontalLayout_4.addWidget(self.glw)
        ...
        sizePolicy1.setHeightForWidth(self.codeView.sizePolicy().hasHeightForWidth())
        self.codeView.setSizePolicy(sizePolicy1)
        self.codeView.setMinimumSize(QSize(500, 450))
        self.codeView.setMaximumSize(QSize(500, 16777215))
        font2 = QFont()
